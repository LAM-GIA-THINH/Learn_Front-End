...
createServer({
    ...
    routes() {
        ...
        // ⚠️ Đây là một phiên bản xác thực cực kỳ đơn giản. Vui lòng không
        // sử dụng cách này trong thế giới thực, và đừng bao giờ lưu mật khẩu
        // dạng văn bản thuần (raw text) trong cơ sở dữ liệu của bạn 😅
