/**
 * Thách thức: Lấy một hình ảnh ngẫu nhiên từ Unsplash và đặt làm hình nền
 * 
 * Phần 1:
 * 
 * URL: https://apis.scrimba.com/unsplash/photos/random?orientation=landscape&query=nature
 * (Bạn có thể thay đổi "query" ở cuối URL để chọn chủ đề khác)
 * 
 * Thay đổi thuộc tính backgroundImage của body thành:
 * `url(<chèn URL của hình ảnh từ API vào đây>)`
 * 
 * (Bạn có thể cần khám phá một chút trong phản hồi của API để tìm URL này)
 * 
 * (Lưu ý: CSS để điều chỉnh kích thước hình ảnh đã được thêm sẵn.
 * Hướng dẫn cho việc này được tìm thấy trên CSS Tricks: 
