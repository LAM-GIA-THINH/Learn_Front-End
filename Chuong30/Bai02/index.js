/**
 * Thách thức phần 2: Hiển thị tên tác giả của hình ảnh
 * 
 * Với dữ liệu đã lấy được, hiển thị tên của tác giả 
 * hình ảnh trên trang. Tên tác giả được trả về dưới 
 * dạng "user" trong dữ liệu từ API.
 * 
 * Chưa cần lo lắng về việc định vị tên tác giả ở góc dưới bên trái.
 */
