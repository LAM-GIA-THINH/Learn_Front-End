...
/*
Thử thách:
1. Tạo hàm mới "renderEmotionsRadios" nhận một tham số duy nhất. Đặt tên tham số đó là "cats".
2. Bên trong hàm renderEmotionsRadios, thiết lập một hằng số có tên là "emotions" 
   và gán giá trị của nó bằng kết quả trả về từ việc gọi hàm getEmotionsArray, truyền "cats" làm tham số.
3. Hiện tại, hàm renderEmotionsRadios chỉ cần ghi log "emotions".
4. Gọi hàm renderEmotionsRadios và truyền catsData làm tham số.
*/
