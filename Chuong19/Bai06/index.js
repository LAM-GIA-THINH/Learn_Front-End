...
/*
Thách thức:
1. Nắm quyền kiểm soát thẻ div có id là 'emotion-radios'.
2. Trong hàm renderEmotionsRadios, tạo một biến let 
   để chứa chuỗi HTML của chúng ta. Bạn có thể khởi tạo
   nó với một chuỗi rỗng.
3. Lặp qua mảng "emotions" và đưa mỗi cảm xúc 
   vào một thẻ <p>, sau đó thêm chúng vào biến let bạn 
   đã tạo ở bước 2.
4. Hiển thị chuỗi này lên thẻ div có id là 'emotion-radios'.
*/ 
